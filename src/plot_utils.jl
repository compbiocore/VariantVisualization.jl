...
function process_plot_inputs(chrom_label_info,sample_names,chr_pos_tuple_list_rev)
    ...
    #chr_pos_tuple_list=Array{Tuple{Any,Int64}}(0) #use this if tuple to string doesnt work
    chr_pos_tuple_list=Array{String}(0) #use this if tuple to string doesnt work
